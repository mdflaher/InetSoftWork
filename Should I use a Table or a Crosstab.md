...
with horizontal and vertical groupings along row and column headers, and calculated values populated throughout. ( A pivot table is a table o aggregates of groups of individual values from a more extensive table, aggregated within one or more discrete categories.)
